...
$(this).find('a.'+options.deleteCssClass).click(function(){
    ...
    var forms=$('.'+options.formCssClass);$('#id_'+options.prefix+'-TOTAL_FORMS').val(forms.length);
    ...
    if($(this).length && $('.'+options.formCssClass).length < parseInt($('#id_'+options.prefix+'-MAX_NUM_FORMS').val())){
        var $addBtn;
